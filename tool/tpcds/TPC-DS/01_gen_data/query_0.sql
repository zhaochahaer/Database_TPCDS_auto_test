...
-- start query 2 in stream 0 using template query7.tpl and seed 963045304
select  i_item_id, 
...
-- start query 5 in stream 0 using template query39.tpl and seed 345591136
with inv as
...
-- start query 6 in stream 0 using template query80.tpl and seed 1355758293
with ssr as
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-04' as date) 
                  and (cast('2002-08-04' as date) +  '30 days'::interval)
       and ss_store_sk = s_store_sk
...
-- start query 8 in stream 0 using template query19.tpl and seed 1232208576
...
-- start query 9 in stream 0 using template query25.tpl and seed 1327317894
select  
 i_item_id
 ,i_item_desc
 ,s_store_id
...
-- start query 10 in stream 0 using template query78.tpl and seed 2017787633
with ws as
...
-- start query 11 in stream 0 using template query86.tpl and seed 2042478054
select * from (select   
...
-- start query 12 in stream 0 using template query1.tpl and seed 148078606
...
-- start query 13 in stream 0 using template query91.tpl and seed 379976764
select  
...
-- start query 14 in stream 0 using template query21.tpl and seed 176862195
select  *
 from(select w_warehouse_name
   ...
   where i_current_price between 0.99 and 1.49
     ...
     and inv_warehouse_sk   = w_warehouse_sk
     and inv_date_sk    = d_date_sk
     and d_date between (cast ('2000-05-19' as date) - '30 days'::interval)
                    and (cast ('2000-05-19' as date) + '30 days'::interval)
...
-- start query 15 in stream 0 using template query43.tpl and seed 2011001088
...
-- start query 16 in stream 0 using template query27.tpl and seed 949868841
select  i_item_id,
...
-- start query 17 in stream 0 using template query94.tpl and seed 1389052096
select  
...
where
    d_date between '1999-5-01' and 
           (cast('1999-5-01' as date) + '60 days'::interval)
...
-- start query 18 in stream 0 using template query45.tpl and seed 1167729076
...
-- start query 19 in stream 0 using template query58.tpl and seed 1734100071
with ss_items as
...
-- start query 20 in stream 0 using template query64.tpl and seed 1074627561
with cs_ui as
 (select cs_item_sk
...
-- start query 22 in stream 0 using template query33.tpl and seed 167798424
with ss as (
 select
...
-- start query 23 in stream 0 using template query46.tpl and seed 253524626
select  c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
 ...
 from
   (select ss_ticket_number
    ...
    and store.s_city in ('Union','Lakeview','Hopewell','Highland Park','Stringtown') 
...
-- start query 24 in stream 0 using template query62.tpl and seed 380833534
select  
...
-- start query 25 in stream 0 using template query16.tpl and seed 965871392
select  
...
and cc_county in ('Jefferson Davis Parish','Wadena County','Kittitas County','Oglethorpe County',
                  'Pennington County'
)
and exists (select *
...
-- start query 26 in stream 0 using template query10.tpl and seed 1844800740
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
 ...
 where
  ...
  ca_county in ('Houston County','Lake County','Garland County','Henderson County','Catawba County') and
...
-- start query 27 in stream 0 using template query63.tpl and seed 197141794
select  * 
...
-- start query 28 in stream 0 using template query69.tpl and seed 317618635
select  
  cd_gender,
  cd_marital_status,
  cd_education_status,
...
-- start query 29 in stream 0 using template query60.tpl and seed 1812682114
with ss as (
 select
...
-- start query 30 in stream 0 using template query59.tpl and seed 1545273656
with wss as 
 (select d_week_seq,
        ss_store_sk,
        sum(case when (d_day_name='Sunday') then ss_sales_price else null end) sun_sales,
...
-- start query 31 in stream 0 using template query37.tpl and seed 1892963341
select  i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and d_date between cast('1998-04-29' as date) and (cast('1998-04-29' as date) +  '60 days'::interval)
...
-- start query 32 in stream 0 using template query98.tpl and seed 85586568
select i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
where 
	ss_item_sk = i_item_sk 
  	and i_category in ('Men', 'Electronics', 'Jewelry')
  	and ss_sold_date_sk = d_date_sk
	and d_date between cast('2002-04-01' as date) 
				and (cast('2002-04-01' as date) + '30 days'::interval)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- start query 33 in stream 0 using template query85.tpl and seed 194087416
...
-- start query 34 in stream 0 using template query70.tpl and seed 2147024566
select * from (select  
...
-- start query 35 in stream 0 using template query67.tpl and seed 874160221
select  *
...
-- start query 36 in stream 0 using template query28.tpl and seed 1430970143
select  *
...
-- start query 37 in stream 0 using template query81.tpl and seed 1093348998
with customer_total_return as
...
-- start query 38 in stream 0 using template query97.tpl and seed 2046525654
with ssci as (
...
-- start query 39 in stream 0 using template query66.tpl and seed 345652315
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 ...
 from (
 	...
 	,w_state
 	,w_country
 	,'USPS' || ',' || 'BOXBUNDLES' as ship_carriers
       ,d_year as year
 	...
 	and ws_ship_mode_sk = sm_ship_mode_sk
        and d_year = 1998
 	and t_time between 39053 and 39053+28800 
 	and sm_carrier in ('USPS','BOXBUNDLES')
     group by 
        w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
-- start query 40 in stream 0 using template query90.tpl and seed 1810401979
...
-- start query 41 in stream 0 using template query17.tpl and seed 1877750357
select  i_item_id
       ,i_item_desc
       ,s_state
...
-- start query 42 in stream 0 using template query47.tpl and seed 1079805600
with v1 as(
...
-- start query 43 in stream 0 using template query95.tpl and seed 635657674
with ws_wh as
...
where
    d_date between '2001-2-01' and 
           (cast('2001-2-01' as date) + '60 days'::interval)
and ws1.ws_ship_date_sk = d_date_sk
and ws1.ws_ship_addr_sk = ca_address_sk
and ca_state = 'TX'
and ws1.ws_web_site_sk = web_site_sk
...
-- start query 45 in stream 0 using template query3.tpl and seed 176623039
select  dt.d_year 
...
-- start query 46 in stream 0 using template query51.tpl and seed 681016319
WITH web_v1 as (
select
...
-- start query 47 in stream 0 using template query35.tpl and seed 1184061974
select   
  ca_state,
  cd_gender,
  cd_marital_status,
...
-- start query 48 in stream 0 using template query49.tpl and seed 181228755
select  
 'web' as channel
 ,web.item
 ,web.return_ratio
...
-- start query 49 in stream 0 using template query9.tpl and seed 154265903
select case when (select count(*) 
                  from store_sales 
                  where ss_quantity between 1 and 20) > 11873841
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 21 and 40) > 4567509
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 41 and 60) > 7859002
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 61 and 80) > 19526768
            then (select avg(ss_ext_tax)
                  from store_sales
       ...
       case when (select count(*)
                  from store_sales
                  where ss_quantity between 81 and 100) > 12856651
            then (select avg(ss_ext_tax)
                  from store_sales
...
-- start query 50 in stream 0 using template query31.tpl and seed 1431358482
with ss as
...
-- start query 51 in stream 0 using template query11.tpl and seed 1636898002
with year_total as (
...
-- start query 52 in stream 0 using template query93.tpl and seed 2079201544
...
-- start query 53 in stream 0 using template query29.tpl and seed 1208025168
select   
     i_item_id
    ,i_item_desc
    ,s_store_id
...
-- start query 54 in stream 0 using template query38.tpl and seed 968599838
select  count(*) from (
...
-- start query 55 in stream 0 using template query22.tpl and seed 1331433006
...
-- start query 56 in stream 0 using template query89.tpl and seed 1969266635
select  *
from(
...
where ss_item_sk = i_item_sk and
      ...
      ss_store_sk = s_store_sk and
      d_year in (1998) and
        ((i_category in ('Women','Shoes','Jewelry') and
          i_class in ('maternity','athletic','estate')
         )
      or (i_category in ('Men','Music','Books') and
          i_class in ('accessories','classical','home repair') 
        ))
...
-- start query 57 in stream 0 using template query15.tpl and seed 927789996
select  ca_zip
       ,sum(cs_sales_price)
 from catalog_sales
     ,customer
...
-- start query 58 in stream 0 using template query6.tpl and seed 2008320383
...
-- start query 59 in stream 0 using template query52.tpl and seed 134553780
select  dt.d_year
 	,item.i_brand_id brand_id
 	,item.i_brand brand
 	,sum(ss_ext_sales_price) ext_price
...
-- start query 60 in stream 0 using template query50.tpl and seed 1304601038
select  
   s_store_name
  ,s_company_id
  ,s_street_number
...
-- start query 61 in stream 0 using template query42.tpl and seed 2035382364
select  dt.d_year
 	,item.i_category_id
 	,item.i_category
...
-- start query 64 in stream 0 using template query12.tpl and seed 1295334306
select  i_item_id
      ,i_item_desc 
      ,i_category 
      ,i_class 
...
where 
	ws_item_sk = i_item_sk 
  	and i_category in ('Home', 'Books', 'Sports')
  	and ws_sold_date_sk = d_date_sk
	and d_date between cast('2002-04-27' as date) 
				and (cast('2002-04-27' as date) + '30 days'::interval)
group by 
	i_item_id
        ,i_item_desc 
        ,i_category
...
-- start query 65 in stream 0 using template query20.tpl and seed 1798907775
select  i_item_id
       ,i_item_desc 
       ,i_category 
       ,i_class 
 ...
 where cs_item_sk = i_item_sk 
   ...
   and cs_sold_date_sk = d_date_sk
 and d_date between cast('1999-04-18' as date) 
 				and (cast('1999-04-18' as date) + '30 days'::interval)
 group by i_item_id
         ,i_item_desc 
         ,i_category
         ,i_class
...
-- start query 66 in stream 0 using template query88.tpl and seed 1890065125
select  *
from
...
-- start query 67 in stream 0 using template query82.tpl and seed 14311573
select  i_item_id
       ,i_item_desc
       ,i_current_price
 ...
 and inv_item_sk = i_item_sk
 and d_date_sk=inv_date_sk
 and d_date between cast('2001-03-12' as date) and (cast('2001-03-12' as date) +  '60 days'::interval)
 and i_manufact_id in (453,42,128,602)
 and inv_quantity_on_hand between 100 and 500
 and ss_item_sk = i_item_sk
 group by i_item_id,i_item_desc,i_current_price
 order by i_item_id
...
-- start query 68 in stream 0 using template query23.tpl and seed 1562901529
...
-- start query 69 in stream 0 using template query14.tpl and seed 451471051
with  cross_items as
...
-- start query 70 in stream 0 using template query57.tpl and seed 2045661307
with v1 as(
 select i_category, i_brand,
        cc_name,
        d_year, d_moy,
...
-- start query 71 in stream 0 using template query65.tpl and seed 216398279
select 
	s_store_name,
	i_item_desc,
	sc.revenue,
...
-- start query 72 in stream 0 using template query71.tpl and seed 2099482621
...
-- start query 73 in stream 0 using template query34.tpl and seed 96870886
select c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag
   ...
   (select ss_ticket_number
    ...
    and store.s_county in ('Williamson County','Daviess County','Levy County','Maverick County',
                           'Oglethorpe County','San Miguel County','Franklin Parish','Fairfield County')
...
-- start query 74 in stream 0 using template query48.tpl and seed 129029359
...
-- start query 75 in stream 0 using template query30.tpl and seed 1048810699
with customer_total_return as
...
-- start query 76 in stream 0 using template query74.tpl and seed 1448598304
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- start query 77 in stream 0 using template query87.tpl and seed 569589289
select count(*) 
...
-- start query 78 in stream 0 using template query77.tpl and seed 483395756
with ss as
 (select s_store_sk,
         sum(ss_ext_sales_price) as sales,
 ...
 where ss_sold_date_sk = d_date_sk
       and d_date between cast('2002-08-29' as date) 
                  and (cast('2002-08-29' as date) +  '30 days'::interval) 
       and ss_store_sk = s_store_sk
 group by s_store_sk)
 ,
 sr as
...
-- start query 79 in stream 0 using template query73.tpl and seed 1077262881
select c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag 
   ...
   (select ss_ticket_number
    ...
    and date_dim.d_year in (1998,1998+1,1998+2)
    and store.s_county in ('Jefferson Davis Parish','Oglethorpe County','Bronx County','Wadena County')
...
-- start query 80 in stream 0 using template query84.tpl and seed 1321722297
select  c_customer_id as customer_id
 ...
 where ca_city	        =  'Florence'
   and c_current_addr_sk = ca_address_sk
   and ib_lower_bound   >=  41359
   and ib_upper_bound   <=  41359 + 50000
...
-- start query 81 in stream 0 using template query54.tpl and seed 1900983491
...
-- start query 82 in stream 0 using template query55.tpl and seed 439147622
...
-- start query 83 in stream 0 using template query56.tpl and seed 213429516
with ss as (
 ...
 where i_item_id in (select
     i_item_id
from item
where i_color in ('burlywood','bisque','coral'))
 and     ss_item_sk              = i_item_sk
 and     ss_sold_date_sk         = d_date_sk
 and     d_year                  = 1999
 and     d_moy                   = 3
...
-- start query 84 in stream 0 using template query2.tpl and seed 812184922
with wscs as
 (select sold_date_sk
        ,sales_price
...
-- start query 85 in stream 0 using template query26.tpl and seed 1334739189
select  i_item_id, 
...
-- start query 86 in stream 0 using template query40.tpl and seed 1436802981
select  
   w_state
  ,i_item_id
 ...
 and cs_sold_date_sk    = d_date_sk
 and d_date between (cast ('1999-03-20' as date) - '30 days'::interval)
                and (cast ('1999-03-20' as date) + '30 days'::interval) 
 group by
    w_state,i_item_id
...
-- start query 87 in stream 0 using template query72.tpl and seed 835992200
select  i_item_desc
      ,w_warehouse_name
      ,d1.d_week_seq
...
-- start query 88 in stream 0 using template query53.tpl and seed 1682886726
select  * from 
...
-- start query 89 in stream 0 using template query79.tpl and seed 1754439596
select 
...
-- start query 90 in stream 0 using template query18.tpl and seed 599868798
select  i_item_id,
        ca_country,
        ca_state, 
        ca_county,
 ...
 where cs_sold_date_sk = d_date_sk and
       ...
       c_birth_month in (4,9,11,3,5,6) and
       d_year = 2001 and
       ca_state in ('GA','TX','NY'
                   ,'KS','CO','MI','VA')
...
-- start query 91 in stream 0 using template query13.tpl and seed 541809630
select avg(ss_quantity)
 ...
 and((ss_addr_sk = ca_address_sk
  ...
  and ca_state in ('MN', 'NJ', 'TX')
  and ss_net_profit between 100 and 200  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('VA', 'OH', 'IA')
  and ss_net_profit between 150 and 300  
     ) or
     (ss_addr_sk = ca_address_sk
  and ca_country = 'United States'
  and ca_state in ('AK', 'IN', 'GA')
  and ss_net_profit between 50 and 250  
     ))
;

-- end query 91 in stream 0 using template query13.tpl
-- start query 92 in stream 0 using template query24.tpl and seed 1504329462
with ssales as
(select c_last_name
      ,c_first_name
      ,s_store_name
...
-- start query 93 in stream 0 using template query4.tpl and seed 150494048
with year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
...
-- start query 94 in stream 0 using template query99.tpl and seed 1765212217
select  
   substr(w_warehouse_name,1,20)
  ,sm_type
  ,cc_name
...
-- start query 95 in stream 0 using template query68.tpl and seed 592827992
select  c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
 ...
 from (select ss_ticket_number
       ...
       where store_sales.ss_sold_date_sk = date_dim.d_date_sk
        ...
        and date_dim.d_year in (1998,1998+1,1998+2)
        and store.s_city in ('Walnut Grove','Salem')
...
-- start query 96 in stream 0 using template query83.tpl and seed 1586375244
with sr_items as
 (select i_item_id item_id,
 ...
 and   d_date    in 
	...
	where d_week_seq in 
		(select d_week_seq
		from date_dim
	  where d_date in ('1999-07-08','1999-08-04','1999-11-11')))
...
-- start query 97 in stream 0 using template query61.tpl and seed 2020125094
...
-- start query 98 in stream 0 using template query5.tpl and seed 1368517864
with ssr as
 (select s_store_id,
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-25' as date) 
                  and (cast('2001-08-25' as date) +  '14 days'::interval)
...
-- start query 99 in stream 0 using template query76.tpl and seed 1196961565
